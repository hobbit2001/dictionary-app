...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder> {
    ...
    private List<Phonetics> phoneticsList; //list of phonetics that has to be shown in this recyler view
        ...
        holder.imagebutton_audio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    e.printStackTrace();
                    Toast.makeText(context , "couldnt play audio" , Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
